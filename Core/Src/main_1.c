...
Joystick_cfg_t joystick2_cfg = {
    .adc = &hadc1,
    .x_channel = ADC_CHANNEL_5, // A0 / PA0
    .y_channel = ADC_CHANNEL_6, // A1 / PA1
    .sampling_time = ADC_SAMPLETIME_47CYCLES_5,
    .center_x = JOYSTICK_DEFAULT_CENTER_X,
    .center_y = JOYSTICK_DEFAULT_CENTER_Y,
    .deadzone = JOYSTICK_DEADZONE,
...
int main(void)
{
    ...
    // Startup animation
    LCD_printString("MISSION", 72, 42, 1, 2);
    LCD_printString("CONSOLE", 66, 70, 6, 2);
    LCD_printString("Find-Steal-Escape", 36, 116, 1, 1);
    LCD_Refresh(&cfg0);
    HAL_Delay(1000);
