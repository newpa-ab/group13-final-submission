...
/* Draw Packed Image
*   Copies a full-screen 4-bit packed image into the LCD buffer.
*   The image must use the same two-pixels-per-byte layout as the internal buffer. */
void LCD_Draw_Packed_Image(const uint8_t *image);
